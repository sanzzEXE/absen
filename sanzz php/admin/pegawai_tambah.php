...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($koneksi, "INSERT INTO pegawai (nama_pegawai, tgl_lahir, alamat, telp, username, password)
                            VALUES ('$nama_pegawai','$tgl_lahir','$alamat','$telp','$username', '$password')");
...
<div class="container mt-5">
    <h2 class="mb-4 text-center">👨‍🏫 Tambah Data Pegawai</h2>
